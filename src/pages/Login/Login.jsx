    ...
    return (
        <div className="flex items-center pt-24 flex-col">
            <form className="flex flex-col gap-6 p-8 rounded-lg bg-black text-white w-[500px]">
                ...
                <button type="button" className="mt-4 p-4 rounded bg-blue-600 text-white font-bold hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500" onClick={createUsers}>Avançar</button>
            </form>
            {users.map((user) => (
                <div
                    key={user.id}
                ...
                >
                    ...
                    <button className="ml-4 p-2 rounded-md bg-red-600 hover:bg-red-700 transition duration-300"
